...
% read irrigaiton census data (county, actual IrrArea)
county_area_new_act=load([Cesus_IrrArea_data_local, num2str(year_map),'\county_area_new_act.mat'], 'county_area_new_act');
county_area_new=county_area_new_act.county_area_new_act;
...
% xlswrite([Cesus_IrrArea_data_local,num2str(year_map),'\County_area_original.xlsx'],County_Irr_area_all_province);
 xlswrite([Cesus_IrrArea_data_local,num2str(year_map),'\County_area_merge_act.xlsx'],county_area_merge);
