...
sutability_threshod_IrrArea= geotiffread([land_loc,num2str(year_map),'\county_level\test08\GI_sutability_threshold_IrrArea_opt.tif']);
...
xlswrite([output_local,num2str(year_map),'\county_level\test08\GI_Point_accuracy_V3.xlsx'],acccuracy_China, 'acccuracy_China');
xlswrite([output_local,num2str(year_map),'\county_level\test08\GI_Point_accuracy_V3.xlsx'],accuarcy_Province, 'accuarcy_Province');
