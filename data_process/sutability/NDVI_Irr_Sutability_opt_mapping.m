...
geotiffwrite([output_local,num2str(year_map),'\county_level\test08\NDVI_sutability_threshold_IrrArea_opt.tif'],sutability_threshod_IrrArea,Ref, 'GeoKeyDirectoryTag', data_GeoInfor.GeoTIFFTags.GeoKeyDirectoryTag);
