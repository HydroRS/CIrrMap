...
for ii=1:length(dayofyear)
  ...
  ['MOD09Q1.006_sur_refl_b02_doy', num2str(year_map),day_samlength,'_aid0001.tif']
    ...
    for jj=1:31
        ...
        current_province_id_reflect06=modis_refct04_ForestGrass_id{jj};
...
NDWI_ForestGrass_all=NDWI_data_all;
save ([output_fold,num2str(year_map),'\NDWI_ForestGrass_all.mat'], 'NDWI_ForestGrass_all','-v7.3');