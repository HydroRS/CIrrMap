...
modis_refct04_ForestGrass_id=cell(1,31);
for kk=1:31
...
%         data_GeoInfor=geotiffinfo([land_loc,num2str(year_map),'\',['MOD09Q1.006_sur_refl_b02_doy', num2str(year_map),'049','_aid0001.tif']]);
    ...
    modis_refct04_ForestGrass_id{kk}=current_province_modis;
    
end

%%
save([ID_loc,num2str(year_map),'\modis_refct04_ForestGrass_id.mat'],'modis_refct04_ForestGrass_id','-v7.3');
% save('modis_refct04_ForestGrass_id.mat','modis_refct04_ForestGrass_id','-v7.3');
