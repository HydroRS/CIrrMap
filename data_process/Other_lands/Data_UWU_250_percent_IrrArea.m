   ...
   for kk=1:length(Nereast_Irr30_in_Irr250m_lat)
      if rem(kk,1000000)==0
        ...
        current_id_lat=Nereast_Irr30_in_Irr250m_lat(kk);
         ...
         result(kk)=min(length(data_point(data_point>40&data_point<70))/69,1);
...
geotiffwrite([output_local,num2str(year_map),'\2000new2_UWU.tif'],simu_250m,Ref, 'GeoKeyDirectoryTag', data_GeoInfor_base.GeoTIFFTags.GeoKeyDirectoryTag);
