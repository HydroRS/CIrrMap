...
province_crop_id_2000=cell(1,31);
for kk=1:31
...
province_crop_id_2000{kk}=[crop_current_province,lat,lon];

end

%% save result
%  save 'province_crop_id_2000.mat', 'province_crop_id_2000';
save([ID_loc,num2str(year_map),'\province_crop_id_2000.mat'],'province_crop_id_2000','-v7.3');