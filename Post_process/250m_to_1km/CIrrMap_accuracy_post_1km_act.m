...
[CIrrMap1km, Ref] =geotiffread([land_loc,num2str(year_map),'\county_level\test09\2000_Irr_map_county_China_final_post_act_1km.tif']);

% obtaining coordinates of the projected system （pix2map)W
...
xlswrite([output_local,num2str(year_map),'\county_level\test09\CIrrMap1km_Point_accuracy_post_act.xlsx'],acccuracy_China, 'acccuracy_China');
