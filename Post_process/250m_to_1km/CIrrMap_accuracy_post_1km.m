...
[CIrrMap1km, Ref] =geotiffread([land_loc,num2str(year_map),'\county_level\test08\2000_Irr_map_county_China_final_post2_1km.tif']);
...
xlswrite([output_local,num2str(year_map),'\county_level\test08\CIrrMap1km_Point_accuracy_post.xlsx'],acccuracy_China, 'acccuracy_China');
