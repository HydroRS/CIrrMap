...
%% read 250m results
data=imread([land_loc,num2str(year_map),'\county_level\test09\Map250_act_ge.tif']);
data_GeoInfor=geotiffinfo([land_loc,num2str(year_map),'\county_level\test09\Map250_act_ge.tif']);
...
geotiffwrite([output_local,num2str(year_map),'\county_level\test09\2000_Irr_map_county_China_final_post_act_1km.tif'],simu_1km,Ref, 'GeoKeyDirectoryTag', data_GeoInfor_base.GeoTIFFTags.GeoKeyDirectoryTag);
