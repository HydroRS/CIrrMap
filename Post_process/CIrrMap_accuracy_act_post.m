...
sutability_threshod_IrrArea= geotiffread([land_loc,num2str(year_map),'\county_level\test09\2000_Irr_map_county_China_final_act_post.tif']);
...
xlswrite([output_local,num2str(year_map),'\county_level\test09\CIrrMap250_Point_accuracy_act_post.xlsx'],acccuracy_China, 'acccuracy_China');
xlswrite([output_local,num2str(year_map),'\county_level\test09\CIrrMap250_Point_accuracy_act_post.xlsx'],accuarcy_Province, 'accuarcy_Province');
