...
% read province data
[data_crop, Ref] = geotiffread([land_loc,num2str(year_map),'\county_level\Other_IrrMap\zhu_map2000.tif']);
...
CIrrMap= geotiffread([land_loc,num2str(year_map),'\county_level\Other_IrrMap\zhu_map2000.tif']);
...
%% save results
xlswrite([land_loc,num2str(year_map),'\county_level\Other_IrrMap\zhu_map2000_area_sim_obs_county_',num2str(year_map),'.xlsx'],Irr_NonIrr_Area(:,1:end-1));
