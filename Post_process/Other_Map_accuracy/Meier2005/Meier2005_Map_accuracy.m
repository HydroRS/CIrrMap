...
sutability_threshod_IrrArea= geotiffread([land_loc,num2str(year_map),'\county_level\Other_IrrMap\Meier2005.tif']);
...
xlswrite([output_local,num2str(year_map),'\county_level\Other_IrrMap\Meier2005_Point_accuracy.xlsx'],acccuracy_China, 'acccuracy_China');
xlswrite([output_local,num2str(year_map),'\county_level\Other_IrrMap\Meier2005_Point_accuracy.xlsx'],accuarcy_Province, 'accuarcy_Province');
