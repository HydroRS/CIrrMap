...
land_loc='F:\Data_ZL\IrrMap\2000\county_level\test09\';
crop_loc='F:\Data_ZL\IrrMap\2000\';

% year for the land use map
year_map=2000;
[IrrMap_data, Ref] =geotiffread([land_loc,'\2000_Irr_map_county_China_final_act.tif']);
CropMap_data =geotiffread([crop_loc,'\2000new1.tif']);
data_GeoInfor_base=geotiffinfo([land_loc,'\2000_Irr_map_county_China_final_act.tif']);
...
%%
geotiffwrite([land_loc,'\2000_Irr_map_county_China_final_act_post.tif'],IrrMap_data_new,Ref, 'GeoKeyDirectoryTag', data_GeoInfor_base.GeoTIFFTags.GeoKeyDirectoryTag);
