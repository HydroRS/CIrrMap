...
sutability_threshod_IrrArea= geotiffread([land_loc,num2str(year_map),'\county_level\test08\2000_Irr_map_county_China_final_post2.tif']);
...
xlswrite([output_local,num2str(year_map),'\county_level\test08\CIrrMap250_Point_accuracy_post.xlsx'],acccuracy_China, 'acccuracy_China');
xlswrite([output_local,num2str(year_map),'\county_level\test08\CIrrMap250_Point_accuracy_post.xlsx'],accuarcy_Province, 'accuarcy_Province');
